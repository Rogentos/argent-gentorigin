...
# $Header: /var/cvsroot/gentoo-x86/www-apps/mediawiki/mediawiki-1.23.1.ebuild,v 1.1 2014/06/26 06:52:33 radhermit Exp $
...
src_compile() {
	epatch "$FILESDIR"/0001-PCRE-8.34-compat-patch.patch
}
