...
# $Header: /var/cvsroot/gentoo-x86/www-apps/mediawiki/mediawiki-1.19.15.ebuild,v 1.4 2014/04/13 14:02:03 ago Exp $
...
RESTRICT="test"
src_compile() {
	epatch "$FILESDIR"/0001-Quick-and-dirty-PCRE-8.34-compat-patch.patch
}
src_install() {
	webapp_src_preinst
